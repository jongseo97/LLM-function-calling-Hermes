...
def CAS_to_SMILES(cas : str) -> str:
    """
    Get SMILES of chemical for a given CAS number.
...
def SMILES_to_CID(smiles : str) -> str:
    """
    Get CID of chemical for a given SMILES.
...
def cid_to_name(cid : str) -> str:
    """
    get name of chemical for a given cid.

    Args:
        cid (str): CID number

    Returns:
        str: name of chemical
    """
